...
<%-- ----------------------------------------------------------------
 名称： a page that redirect back to housing search screen

 2015/08/20     Duong.Nguyen		Create new file
---------------------------------------------------------------- --%>
<html lang="ja">
<head>
...
<form name="inputform" method="post" action="<c:out value="${pageContext.request.contextPath}/top/housing/list/"/>">
