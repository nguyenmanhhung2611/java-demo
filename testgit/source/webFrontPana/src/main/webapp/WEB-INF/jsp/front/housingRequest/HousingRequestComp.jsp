...
<title>物件リクエスト　完了｜<c:out value="${commonParameters.panaReSmail}"/></title>
...
<div id="contents">
	<div id="contentsInner">
		<c:import url="../include/common/topicPath.jsh?pattern=REQ-01-07" />
		...
		<div class="section01">
			...
			<div class="contentsInner01 mt30 mb50 spMt15 spMb15">
				<p class="bold mb30 spMb10 f18 spF16 center spLeft">物件リクエストの送信が完了しました。</p>
				<p class="f14 center spLeft">ご登録いただいたメールアドレスにメールを送信しましたのでご確認ください。<br>リクエスト情報に合致する物件が見つかり次第、不動産会社担当者よりご連絡させていただきます。</p>
			</div>
