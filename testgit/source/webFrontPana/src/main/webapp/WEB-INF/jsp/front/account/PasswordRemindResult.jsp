...
<title>パスワードのお問い合わせ　送信完了｜<c:out value="${commonParameters.panaReSmail}"/></title>
...
<div id="contents">
	<div id="contentsInner">
		<c:import url="../include/common/topicPath.jsh?pattern=MYP-03-04" />
		...
		<div class="section01">
			...
			<div class="contentsInner01 mt30 mb50 spMt15 spMb15">
				<p class="bold mb30 spMb10 f18 spF16 center spLeft">パスワード再設定用URLを送信しました。</p>
