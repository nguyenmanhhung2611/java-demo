...
<!--
	...
	function linkToCsv(url) {
		document.informationform.action = url;
		document.informationform.target = "_blank";
		document.informationform.submit();
		document.informationform.target = "_self";
	}
...
// -->
	...
	<div class="headingAreaInner">
		...
		<form action="./list/" method="post" name="informationform">
		...
		<div class="flexBlockA01">
			<table width="100%" cellspacing="0" cellpadding="0" class="tableA1">
				<tr>
					...
					<td><input name="keyInformationNo" value="<c:out value="${searchForm.keyInformationNo}"/>" type="text" size="10" maxlength="<dm3lookup:lookup lookupName="inputLength" lookupKey="information.input.informationNo" defaultValue="13"/>" class="input2 ime-disabled"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input name="keyInsDateFrom" value="<c:out value="${searchForm.keyInsDateFrom}"/>" type="text" size="10" maxlength="<dm3lookup:lookup lookupName="inputLength" lookupKey="information.input.insDateFrom" defaultValue="10"/>" class="input2 ime-disabled"> &nbsp; ～ &nbsp; <input name="keyInsDateTo" value="<c:out value="${searchForm.keyInsDateTo}"/>" type="text" size="10" maxlength="<dm3lookup:lookup lookupName="inputLength" lookupKey="information.input.insDateTo" defaultValue="10"/>" class="input2 ime-disabled">(yyyy/mm/dd)</td>
				</tr>
				<tr>
					<th class="head_tr" width="15%">対象会員</th>
					<td>
						<div class="inputStyle inputStyle2">
							<input type="text" id="keyUserId" name="keyUserId" value="<c:out value="${searchForm.keyUserId}"/>" type="text" size="10" maxlength="20" class="input2 ime-disabled">
						</div>
						&nbsp;&nbsp; &nbsp;
						<!--btnBlockC11 -->
