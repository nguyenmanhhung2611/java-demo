...
public class PanaCommonManageImpl implements PanaCommonManage {
	...
	private DAO<TblProduct> productDAO;
	...
	public void setProductDAO(DAO<TblProduct> productDAO) {
	...
	public List<RouteMst> getPrefCdToRouteMstListWithGroupBy(String prefCd)
			throws Exception {
		log.debug(">>>PanaCommonManageImpl.getPrefCdToRouteMstListWithGroupBy(String prefCd)<<<");
		log.debug(">>>prefCd is : " + prefCd + "<<<");

		List<RouteMst> routeMstList = new ArrayList<RouteMst>();

		Object[] params = new String[] { prefCd };
		routeMstList = routeMstListDAO.listRouteMstWithGroupBy(params);
	...
	@Override
	public List<TblProduct> getListProduct() throws Exception {
		log.debug(">>>PanaCommonManageImpl.getListProduct()<<<");
		DAOCriteria paramDAOCriteria = new DAOCriteria();
		paramDAOCriteria.addOrderByClause("id");
		return this.productDAO.selectByFilter(paramDAOCriteria);
	}
	...
	public List<News> getListNews() throws Exception {
		...
		return this.newsDAO.selectByFilter(paramDAOCriteria);
	}
