...
<c:param name="pageTitle" value="管理ユーザ情報編集完了画面" />
			...
			<div class="btnBlockC17">
				<div class="btnBlockC17Inner">
					<div class="btnBlockC17Inner2">
						<p>	<a href="javascript:linkToUser('<c:out value="${pageContext.request.contextPath}"/>/top/admin/list/','list');"><span>一覧へ戻る</span></a></p>
					</div>
				</div>
			</div>
			<!--/btnBlockC17 -->
