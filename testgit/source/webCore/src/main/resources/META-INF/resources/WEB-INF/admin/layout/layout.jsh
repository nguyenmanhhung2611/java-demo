...
<html lang="ja">
	...
	<c:set var="user" value="${sessionScope['jp.co.transcosmos.dm3.foundation.User']}"/>
		...
		<!--===||| wrap |||=== -->
		<div id="wrap">
	<c:import url="/WEB-INF/admin/layout/header.jsh" />

			<!--===||| mainArea |||=== -->
			<div id="mainArea" class="clear">
	<c:import url="/WEB-INF/admin/default_jsp/include/menu/sideMenu.jsh" />
				<!--=== contentsArea === -->
				<div id="contentsArea">
					<!--tnavBlockA01 -->
	<c:set var="selectedTabNav" value="main" scope="request"/>
	<c:import url="/WEB-INF/admin/default_jsp/include/menu/menuTab.jsh" />
					<!--/tnavBlockA01 -->
