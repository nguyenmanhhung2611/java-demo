...
<div class="headingAreaInner">
	...
	<c:import url="/WEB-INF/admin/default_jsp/include/building/buildingInfoConfirm.jsh" />
			...
			<div class="btnBlockComp">
				<div class="btnBlockCompInner">
					<div class="btnBlockCompInner2">
						<p><a href="javascript:linkToUrl('../result/', 'insert');"><span>確定</span></a></p>
					</div>
				</div>
			</div>
		</div>
