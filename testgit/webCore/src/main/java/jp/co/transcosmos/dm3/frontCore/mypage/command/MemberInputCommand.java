 ...
 * 【更新登録の場合】<br>
 * <ul>
 * <li>ログインユーザー情報からユーザーＩＤを取得する。</li>
 * <li>ユーザーＩＤに該当するマイページ会員情報を取得する。</li>
 ...
 * H.Mizuno		2015.07.07	ログイン情報を取得するのを更新処理時に限定
 * </pre>
 * <p>
 * 注意事項<br>
 *
...
public class MemberInputCommand implements Command {
	...
	*/
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		// 更新処理の場合、ログインユーザー情報を取得する。
		// もしログインユーザー情報が取得出来ない場合（セッションタイムアウト等）、例外をスローする。
        ...
        // マイページ会員情報を取得
        JoinResult mypageUser = this.userManager.searchMyPageUserPk((String)loginUser.getUserId());
