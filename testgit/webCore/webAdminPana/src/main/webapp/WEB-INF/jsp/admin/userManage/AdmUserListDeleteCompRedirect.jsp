...
<%-- ----------------------------------------------------------------
 名称：a page that redirect back to admin list screen

 2015/08/20     Vinh.Ly Add CSRF Token for Admin Delete
---------------------------------------------------------------- --%>
<html lang="ja">
<head>
...
<form name="inputform" method="post" action="<c:out value="${pageContext.request.contextPath}/top/admin/list/"/>">
