...
public class PanaHousingRequestForm extends HousingRequestForm implements Validateable {
	 ...
	 * 中古マンションの予算下限 の値は、フレームワークの URL マッピングで使用する 中古マンションの予算下限 クラスの切り替えにも使用される。<br/>
	 * <br/>
	 *
	 * @return 中古マンションの予算下限
	 */
	 ...
	 * 中古マンションの予算上限 の値は、フレームワークの URL マッピングで使用する 中古マンションの予算上限 クラスの切り替えにも使用される。<br/>
	 * <br/>
	 *
	 * @return 中古マンションの予算上限
	 */
	...
	public void setDefaultData(HousingRequest requestInfo) {
		...
		// 賃料/価格・下限値
		if(PanaCommonConstant.HOUSING_KIND_CD_MANSION.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(requestInfo.getHousingRequestInfo().getPriceLower())){
			this.priceLowerMansion = String.valueOf(requestInfo.getHousingRequestInfo().getPriceLower()/10000);

		}
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(requestInfo.getHousingRequestInfo().getPriceLower())){
			this.priceLowerHouse = String.valueOf(requestInfo.getHousingRequestInfo().getPriceLower()/10000);
		}
		if(PanaCommonConstant.HOUSING_KIND_CD_GROUND.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(requestInfo.getHousingRequestInfo().getPriceLower())){
			this.priceLowerLand = String.valueOf(requestInfo.getHousingRequestInfo().getPriceLower()/10000);
		}
		// 賃料/価格・上限値
		if(PanaCommonConstant.HOUSING_KIND_CD_MANSION.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(requestInfo.getHousingRequestInfo().getPriceUpper())){
			this.priceUpperMansion = String.valueOf(requestInfo.getHousingRequestInfo().getPriceUpper()/10000);
		}
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(requestInfo.getHousingRequestInfo().getPriceUpper())){
			this.priceUpperHouse = String.valueOf(requestInfo.getHousingRequestInfo().getPriceUpper()/10000);
		}
		if(PanaCommonConstant.HOUSING_KIND_CD_GROUND.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(requestInfo.getHousingRequestInfo().getPriceUpper())){
			this.priceUpperLand = String.valueOf(requestInfo.getHousingRequestInfo().getPriceUpper()/10000);
		}

		jp.co.transcosmos.dm3.corePana.vo.HousingRequestInfo panaHousingRequestInfo = (jp.co.transcosmos.dm3.corePana.vo.HousingRequestInfo)requestInfo.getHousingRequestInfo();
		...
		// 専有面積・下限値
		if(PanaCommonConstant.HOUSING_KIND_CD_MANSION.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getPersonalAreaLower())){
			this.personalAreaLowerMansion = String.valueOf(panaHousingRequestInfo.getPersonalAreaLower()).substring(0, String.valueOf(panaHousingRequestInfo.getPersonalAreaLower()).length()-3);
		}
		// 専有面積・上限値
		if(PanaCommonConstant.HOUSING_KIND_CD_MANSION.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getPersonalAreaUpper())){
			this.personalAreaUpperMansion = String.valueOf(panaHousingRequestInfo.getPersonalAreaUpper()).substring(0, String.valueOf(panaHousingRequestInfo.getPersonalAreaUpper()).length()-3);
		}
		// 建物面積_下限
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getBuildingAreaLower())){
			this.buildingAreaLowerHouse = String.valueOf(panaHousingRequestInfo.getBuildingAreaLower()).substring(0, String.valueOf(panaHousingRequestInfo.getBuildingAreaLower()).length()-3);
		}
		if(PanaCommonConstant.HOUSING_KIND_CD_GROUND.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getBuildingAreaLower())){
			this.buildingAreaLowerLand = String.valueOf(panaHousingRequestInfo.getBuildingAreaLower()).substring(0, String.valueOf(panaHousingRequestInfo.getBuildingAreaLower()).length()-3);
		}
		// 建物面積_上限
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getBuildingAreaUpper())){
			this.buildingAreaUpperHouse = String.valueOf(panaHousingRequestInfo.getBuildingAreaUpper()).substring(0, String.valueOf(panaHousingRequestInfo.getBuildingAreaUpper()).length()-3);
		}
		if(PanaCommonConstant.HOUSING_KIND_CD_GROUND.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getBuildingAreaUpper())){
			this.buildingAreaUpperLand = String.valueOf(panaHousingRequestInfo.getBuildingAreaUpper()).substring(0, String.valueOf(panaHousingRequestInfo.getBuildingAreaUpper()).length()-3);
		}
		// 土地面積_下限
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getLandAreaLower())){
			this.landAreaLowerHouse = String.valueOf(panaHousingRequestInfo.getLandAreaLower()).substring(0, String.valueOf(panaHousingRequestInfo.getLandAreaLower()).length()-3);
		}
		if(PanaCommonConstant.HOUSING_KIND_CD_GROUND.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getLandAreaLower())){
			this.landAreaLowerLand = String.valueOf(panaHousingRequestInfo.getLandAreaLower()).substring(0, String.valueOf(panaHousingRequestInfo.getLandAreaLower()).length()-3);
		}
		// 土地面積_上限
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getLandAreaUpper())){
			this.landAreaUpperHouse = String.valueOf(panaHousingRequestInfo.getLandAreaUpper()).substring(0, String.valueOf(panaHousingRequestInfo.getLandAreaUpper()).length()-3);
		}
		if(PanaCommonConstant.HOUSING_KIND_CD_GROUND.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getLandAreaUpper())){
			this.landAreaUpperLand = String.valueOf(panaHousingRequestInfo.getLandAreaUpper()).substring(0, String.valueOf(panaHousingRequestInfo.getLandAreaUpper()).length()-3);
		}
		// 間取CD
		String[] layoutArray = new String[requestInfo.getHousingReqLayouts().size()];
		if(PanaCommonConstant.HOUSING_KIND_CD_MANSION.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(requestInfo.getHousingReqLayouts())){
		...
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(requestInfo.getHousingReqLayouts())){
			for(int idx=0;idx<requestInfo.getHousingReqLayouts().size();idx++){
				layoutArray[idx] = requestInfo.getHousingReqLayouts().get(idx).getLayoutCd();
			}
		...
		// 築年月
		if(PanaCommonConstant.HOUSING_KIND_CD_MANSION.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getBuiltMonth())){
			this.compDateMansion = String.valueOf(panaHousingRequestInfo.getBuiltMonth());
		}
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(panaHousingRequestInfo.getBuiltMonth())){
		...
		if(PanaCommonConstant.HOUSING_KIND_CD_MANSION.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(requestInfo.getHousingReqParts())){
		...
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd()) && !StringUtils.isEmpty(requestInfo.getHousingReqParts())){
			for(int idx=0;idx<requestInfo.getHousingReqParts().size();idx++){
				iconArray[idx] = requestInfo.getHousingReqParts().get(idx).getPartSrchCd();
			}
	...
	protected void valHousingKindCd(List<ValidationFailure> errors) {
		// 物件種別入力チェック
        ValidationChain valHousingKindCd = new ValidationChain("housingRequest.input.valHousingKindCd", this.getHousingKindCd());
        // 必須チェック
    ...
    protected void valCompDateCheck(List<ValidationFailure> errors) {
    	 ...
    	 if(valCompDate!= null){
    		// code-lookupチェック
        	valCompDate.addValidation(new CodeLookupValidation(
                    this.codeLookupManager, "compDate"));
			...
			if(this.getIconCdMansion() != null){
				for(int i=0;i<this.getIconCdMansion().length;i++){
					...
					if(valIconCd!= null){
						...
						// code-lookupチェック
						valIconCd.addValidation(new CodeLookupValidation(this.codeLookupManager, "recommend_point_icon_list"));
    ...
    protected void valPrice(List<ValidationFailure> errors) {
    	...
    	if(valPriceLower!= null){
    		// code-lookupチェック
        	valPriceLower.addValidation(new CodeLookupValidation(
                    this.codeLookupManager, "price"));
    	...
    	if(valPriceUpper!= null){
    		valPriceUpper.addValidation(new CodeLookupValidation(
                    this.codeLookupManager, "price"));
    ...
    protected void valPersonalArea(List<ValidationFailure> errors) {
        ...
        if(PanaCommonConstant.HOUSING_KIND_CD_MANSION.equals(this.getHousingKindCd())){
        	valPersonalAreaLower = new ValidationChain("housingRequest.input.valPersonalAreaLower", this.getPersonalAreaLowerMansion());
        	valPersonalAreaUpper = new ValidationChain("housingRequest.input.valPersonalAreaUpper", this.getPersonalAreaUpperMansion());
        	areaUpper = this.getPersonalAreaUpperMansion();
        }

    	if(valPersonalAreaLower!= null){
    		// code-lookupチェック
            valPersonalAreaLower.addValidation(new CodeLookupValidation(
                    this.codeLookupManager, "area"));
    		// 予算_下限＞予算_上限
    	...
    	if(valPersonalAreaUpper!= null){
    		// code-lookupチェック
    		valPersonalAreaUpper.addValidation(new CodeLookupValidation(
                    this.codeLookupManager, "area"));
    ...
    protected void valBuildingArea(List<ValidationFailure> errors) {
    	...
    	if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd())){
    		valBuildingAreaLower = new ValidationChain("housingRequest.input.valBuildingAreaLower", this.getBuildingAreaLowerHouse());
    		valBuildingAreaUpper = new ValidationChain("housingRequest.input.valBuildingAreaUpper", this.getBuildingAreaUpperHouse());
    		buildingAreaUpper = this.getBuildingAreaUpperHouse();
        }
    	if(PanaCommonConstant.HOUSING_KIND_CD_GROUND.equals(this.getHousingKindCd())){
    		valBuildingAreaLower = new ValidationChain("housingRequest.input.valBuildingAreaLower", this.getBuildingAreaLowerLand());
    		valBuildingAreaUpper = new ValidationChain("housingRequest.input.valBuildingAreaUpper", this.getBuildingAreaUpperLand());
    		buildingAreaUpper = this.getBuildingAreaUpperLand();
    	}

    	if(valBuildingAreaLower!= null){
    		// code-lookupチェック
        	valBuildingAreaLower.addValidation(new CodeLookupValidation(
                    this.codeLookupManager, "area"));
    		// 建物面積_下限＞建物面積_上限
    	...
    	if(valBuildingAreaUpper!= null){
    		// code-lookupチェック
        	valBuildingAreaUpper.addValidation(new CodeLookupValidation(
                    this.codeLookupManager, "area"));
    ...
    protected void valLandArea(List<ValidationFailure> errors) {
    	...
    	if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd())){
    		valLandAreaLower = new ValidationChain("housingRequest.input.valLandAreaLower", this.getLandAreaLowerHouse());
    		valLandAreaUpper = new ValidationChain("housingRequest.input.valLandAreaUpper", this.getLandAreaUpperHouse());
    		landAreaUpper = this.getLandAreaUpperHouse();
        }
    	if(PanaCommonConstant.HOUSING_KIND_CD_GROUND.equals(this.getHousingKindCd())){
    		valLandAreaLower = new ValidationChain("housingRequest.input.valLandAreaLower", this.getLandAreaLowerLand());
    		valLandAreaUpper = new ValidationChain("housingRequest.input.valLandAreaUpper", this.getLandAreaUpperLand());
    		landAreaUpper = this.getLandAreaUpperLand();
    	}

    	if(valLandAreaLower!= null){
    		// code-lookupチェック
        	valLandAreaLower.addValidation(new CodeLookupValidation(
                    this.codeLookupManager, "area"));
    		// 土地面積_下限＞土地面積_上限
    	...
    	if(valLandAreaUpper!= null){
    		// code-lookupチェック
    		valLandAreaUpper.addValidation(new CodeLookupValidation(
                    this.codeLookupManager, "area"));
	...
	public void copyToHousingRequestInfo(String userId, HousingRequestInfo housingRequestInfo) {
		...
		if(PanaCommonConstant.HOUSING_KIND_CD_MANSION.equals(this.getHousingKindCd())){
			if(!StringValidateUtil.isEmpty(this.personalAreaLowerMansion)){
				housingRequestInfo.setPersonalAreaLower(BigDecimal.valueOf(Long.valueOf(this.personalAreaLowerMansion)));
			}else{
		...
		if(PanaCommonConstant.HOUSING_KIND_CD_MANSION.equals(this.getHousingKindCd())){
			if(!StringValidateUtil.isEmpty(this.personalAreaUpperMansion)){
				housingRequestInfo.setPersonalAreaUpper(BigDecimal.valueOf(Long.valueOf(this.personalAreaUpperMansion)));
			}else{
		...
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd())){
			if(!StringValidateUtil.isEmpty(this.buildingAreaLowerHouse)){
				panaHousingRequestInfo.setBuildingAreaLower(BigDecimal.valueOf(Long.valueOf(this.buildingAreaLowerHouse)));
			}else{
		...
		if(PanaCommonConstant.HOUSING_KIND_CD_GROUND.equals(this.getHousingKindCd())){
			if(!StringValidateUtil.isEmpty(this.buildingAreaLowerLand)){
				panaHousingRequestInfo.setBuildingAreaLower(BigDecimal.valueOf(Long.valueOf(this.buildingAreaLowerLand)));
			}else{
				panaHousingRequestInfo.setBuildingAreaLower(null);
			}
		}
		...
		if(PanaCommonConstant.HOUSING_KIND_CD_HOUSE.equals(this.getHousingKindCd())){
			if(!StringValidateUtil.isEmpty(this.buildingAreaUpperHouse)){
				panaHousingRequestInfo.setBuildingAreaUpper(BigDecimal.valueOf(Long.valueOf(this.buildingAreaUpperHouse)));
			}else{
		...
		if(PanaCommonConstant.HOUSING_KIND_CD_GROUND.equals(this.getHousingKindCd())){
			if(!StringValidateUtil.isEmpty(this.buildingAreaUpperLand)){
				panaHousingRequestInfo.setBuildingAreaUpper(BigDecimal.valueOf(Long.valueOf(this.buildingAreaUpperLand)));
			}else{
				panaHousingRequestInfo.setBuildingAreaUpper(null);
			}
		}
