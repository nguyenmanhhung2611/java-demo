...
public class PanaReformPartCreator implements HousingPartCreator {
    ...
    /**
     * Map of category part. <br/>
     * Each entry is couple of key-value. key = category ID value = category part CD
     */
    ...
    /**
     * Setter for housingPartInfoDAO
     * @param housingPartInfoDAO Housing part information DAO
     */
    ...
    /**
     * Setter for valueObjectFactory
     * @param valueObjectFactory Factory of value object
     */
    ...
    /**
     * Inject map of category.<br/>
     * Beside, loop through this map to get all category part CDs
     * 
     * @param categoryToPart Map of categories
     */
    public synchronized void setCategoryToPart(
            Map<String, String> categoryToPart) {
        ...
        this.myCategoryPartCds = partCdSet
                .toArray(new String[partCdSet.size()]);
    }

    /**
     * Determine methods to generate new part information.<br/>
     * @param methodName Method name
     * @return true if method name is "addReform" or "updReform"" or "delReform"
     */
    @Override
    public boolean isExecuteMethod(String methodName) {
        ...
        if ("addReform".equals(methodName) || "updReform".equals(methodName)
    ...
    /**
     * Generate part info about reform category from the given housing. <br/>
     * The processing includes deleting old info and adding new info.
    ...
    public void createPart(Housing housing) throws Exception {
        ...
        for (Map<String, Object> reforms : reformList) {
            ...
            if (reformPlan != null) {
                String partCd = this.categoryToPart.get(reformPlan
                        .getPlanCategory1());
                if (!StringValidateUtil.isEmpty(partCd)
                        && addPartMap.get(partCd) == null) {
                    addPartMap.put(partCd,
                            createHousingPartInfo(housingInfo, partCd));
                }
        ...
        this.housingPartInfoDAO.insert(addPartMap.values().toArray(
                new HousingPartInfo[addPartMap.size()]));
    }
    ...
    /**
     * Create a new part info of the given housing
     * @param housingInfo the given housing info
     * @param partCd part info code
     * @return Housing Part info
     */
    protected HousingPartInfo createHousingPartInfo(HousingInfo housingInfo,
            String partCd) {
        // Value オブジェクトを生成してプロパティ値を設定する。
        HousingPartInfo housingPartInfo = (HousingPartInfo) this.valueObjectFactory
                .getValueObject("HousingPartInfo");
