...
<%-- ----------------------------------------------------------------
 名称：a page that redirect back to member list screen
...
<form name="searchForm" method="post" action="<c:out value="${pageContext.request.contextPath}/top/comment/list/${news.newsId}"/>">
